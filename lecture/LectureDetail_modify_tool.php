...
//构造sql语句
$query_lec="update lecture set lectime='{$lectime}',lecplace='{$lecplace}',lecmess='{$lecmess}',firstddl='{$firstddl}',secondddl='{$secondddl}' where lecname='{$lecname}'";
$query_app_delete="delete from apportion where lecname='{$lecname}'";
